...
require_once 'ChangesetModifiedElementsParser.class.php';

/** Fetches the modified element ids for a given changeset from the OSM API 0.6. 
 *
 *  See https://wiki.openstreetmap.org/wiki/API_v0.6#Download:_GET_.2Fapi.2F0.6.2Fchangeset.2F.23id.2Fdownload
 */
class ChangesetModifiedElementsFetcher
{
    private $user;
    private $pass;
    private $parser;
    ...
    public function fetch(int $changeset_id): array
    {
